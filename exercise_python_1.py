...
# 16. Let’s start printing up their receipt! Begin by printing out the heading for their itemization. Print the phrase "Customer One Items" and then print customer_one_itemization."
print("Customer One Items:")
print(customer_one_itemization)

# 17. Now add a heading for their total cost: Print out "Customer One Total". Now print out their total! Our first customer now has a receipt for the things they purchased.
