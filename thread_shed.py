...
# 3. Split daily_sales_replaced around commas and save it to a new list daily_transactions.

daily_transactions = daily_sales_replaced.split(',')

# 4. Our next step is to split each individual transaction into a list of its data points. First, define an empty list daily_transactions_split
...
# 5. It looks like each data item has inconsistent whitespace around it. First, define an empty list transactions_clean.
...
# 6. Create three empty lists. customers, sales, and thread_sold. We are going to collect the individual data points for each transaction in these lists.
# Then, iterate through transactions_clean and for each transaction:
...
# 7. First, define a variable called total_sales and set it equal to 0. Now, consider the list sales. It is a list of strings that we want to sum. In order for us to sum these values, we will have to remove the $, and set them equal to floats.
